...
namespace DataAccessLayer.Concrete
{
    public class CourseDal : ICourseDal
    {
        ...
        public CourseDal()
        {
            ...
            {
                new Course { Id = 1, CourseName = "C# & Java", Description = "Nesneye Dayalı Programlama(OOP)", Price = 10, CategoryId = 1, InstructorId = 1 },
                new Course { Id = 2, CourseName = "JavaScript", Description = "Methodlar ve Değiskenler", Price = 20, CategoryId = 2, InstructorId = 2 },
                new Course { Id = 3, CourseName = "HTML & CSS", Description = "Responsive yapı olusturma", Price = 30, CategoryId = 3, InstructorId = 3 }
            };
        }
